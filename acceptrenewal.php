...
{$sql1="update LMS.record set Due_Date=date_add(Due_Date,interval 30 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";
...
{$sql2="update LMS.record set Due_Date=date_add(Due_Date,interval 30 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";
