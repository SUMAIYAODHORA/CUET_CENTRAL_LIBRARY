                           ...
                           ?>
                            ...
                            <form class="form-horizontal row-fluid" action="puspo.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Book/ID of Book/Author Name" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from pdf_file where id='$s' or pdf like '%$s%' or auther like '%$s%'";
                                        }
                                    else
                                    ...
                                    <tr>
                                      ...
                                      <?php
                                        ...
                                        //while($rows = mysqli_fetch_assoc($run2)){
                                            ?>
                                        <a  class="btn btn-success" href="download.php?file=<?php echo $row['pdf'] ?>">Download</a><br>
                                        ...
                                        <td>
                                        <a  class="btn btn-primary" href="<?php echo $filePath ?>" >View</a>
                                        </td>
